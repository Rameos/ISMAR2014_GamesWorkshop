...
public class PTAMFeaturePoints : MonoBehaviour {
	...
	protected Position3DListSink m_FeatureList;
	...
	void Start () {
        ...
        Component[] components = gameObject.GetComponents(typeof(Position3DListSink));
		
		if (components != null && components.Length > 0)
			foreach (Component comp in components)
			{
                Position3DListSink script = (Position3DListSink)comp;
